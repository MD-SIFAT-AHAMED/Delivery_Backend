...
exports.postPayment = async (req, res) => {
  ...
  try {
    const data = {
      ...
      success_url: `https://deliverybackend-production-5675.up.railway.app/api/v1/payment/success-payment?trackingId=${payment.trackingId}`,
      fail_url: `https://deliverybackend-production-5675.up.railway.app/api/v1/payment/fail-payment?trackingId=${payment.trackingId}`,
      cancel_url: `https://deliverybackend-production-5675.up.railway.app/api/v1/payment/cancel-payment?trackingId=${payment.trackingId}`,
